...
> **Sample on GitHub** · `AVGO_1w.csv` (29 rows, `2026-02-12` -> `2026-08-27`, 1.78 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/avgo)** — **870** `1w` rows (full `1m`: 111,396), **11 timeframes**, `2009-12-31` -> `2026-08-27`.
...
| 1w rows | 29 | **870** |
| Size | 1.78 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/avgo) |
